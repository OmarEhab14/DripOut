        ...
        children: [
          ...
          AnimatedContainer(
            ...
            child: SingleChildScrollView(
              // Using SingleChildScrollView prevents layout issues when height is animating
          ...
          CategoryBar(
              categories: const ['All', 'TShirts', 'Jeans', 'Shoes', 'Shirts'],
          ...
          Expanded(
            child: NotificationListener<ScrollNotification>(
              onNotification: (notification) {
                // Additional scroll event handling if needed
                return false;
              },
